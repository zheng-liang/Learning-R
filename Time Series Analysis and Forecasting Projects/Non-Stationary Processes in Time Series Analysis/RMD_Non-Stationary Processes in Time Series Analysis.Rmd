...
We can see that the quadratic trend fits the data better, although it is suggesting that a downturn is forming. The residuals from the `quad_trend` model is plotted, along with the residuals of `linear_trend` for comparison:
