...
```{r plot of actual and SPYTYS fitted values}
plot.zoo(returns_spy["/2022-05",], 
         col = "black", type = "l", lwd = 2, 
         ylab = "SPY Returns", xlab = "Time", 
...
```{r plot of actual and SPYVIX fitted values}
plot.zoo(returns_spy["/2022-05",], 
         col = "black", type = "l", lwd = 2, 
         ylab = "SPY Returns", xlab = "Time", 
...
```{r plot of actual and SPYIJC fitted values}
plot.zoo(returns_spy["/2022-05",], 
         col = "black", type = "l", lwd = 2, 
         ylab = "SPY Returns", xlab = "Time", 
...
```{r plot of actual and SPY_ALL fitted values}
plot.zoo(returns_spy["/2022-05",], 
         col = "black", type = "l", lwd = 2, 
         ylab = "SPY Returns", xlab = "Time", 
