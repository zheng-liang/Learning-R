...
```{r load dataset from wd, message=FALSE, class.source = "fold-show"}
...
```{r head tail, class.source = "fold-show"}
...
```{r adjust column names, class.source = "fold-show"}
...
### 4.5 Evaluating the Performance of the Full Model
...
### 5.2 Evaluating the Stepwise Model
